...
impl ColorForm {
    ...
    pub fn render(&mut self, area: Rect, buf: &mut Buffer) {
        ...
        Self::render_text_field(focused, 1, "Color:", &mut self.color, self.popup_x + 2, y, popup_width - 12, buf);
        self.render_color_preview(&color_val, self.popup_x + popup_width - 8, y + 1, buf);
        y += 3;

        // Category field
        Self::render_text_field(focused, 2, "Category:", &mut self.category, self.popup_x + 2, y, popup_width - 4, buf);
        y += 4;
