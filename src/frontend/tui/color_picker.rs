//! Palette-aware dropdown used by the various color editing forms.
//!
//! Provides quick filtering, tab cycling, and a preview swatch so users can
//! reuse colors consistently across the UI.
